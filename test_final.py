...
for i in range(len(x)):
	zplot11 += [round(avg_strain_tensor[0],3)]
	zplot12 += [round(avg_strain_tensor[1],3)]
	zplot21 += [round(avg_strain_tensor[2],3)]
	zplot22 += [round(avg_strain_tensor[3],3)]

zplot11 = np.array(zplot11)
zplot12 = np.array(zplot12)
zplot21 = np.array(zplot21)
zplot22 = np.array(zplot22)
